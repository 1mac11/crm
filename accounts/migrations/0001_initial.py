    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification_code', models.CharField(blank=True, max_length=10, null=True, verbose_name='verification code')),
                ('type', models.CharField(choices=[('admin', 'admin'), ('employee', 'employee')], default='admin', max_length=10, verbose_name='type')),
