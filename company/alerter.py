...
class Alerter:
    ...
    def custom_send_message(self, text):
    ...
    def send_file(
        ...
        """
        Sends a telegram file to `chat_id`. All params according to https://core.telegram.org/bots/api#se
        ...
        :return: requests.Response
        """
        url = f"{self.base_url}/sendDocument?chat_id={self.chat_id}&caption={caption}&parse_mode={parse_mode}&disable_notification={disable_notification}"
        return default_requests.post(url, files={"document": file})
...
#     try:
#         text = f'''New contact send the request: \n
#     Full name: {instance.name}  {instance.surname}
...
#             tg_alert.send_file(file=file, caption=text)
#
#     except Exception as e:
#         logger.error(e)
